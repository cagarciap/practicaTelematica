        ...
        while True:
            ...
            if (opcion == "SALIR"):
                ...
                try:
                    ...
                    if (str(idCola) == str(idAux) and str(nombreCola) == str(nombreAux) and str(claveAux) == str(
                            claveAcceso)):
                ...
                try:
                    ...
                    if (str(idCanal) == str(idAux) and str(nombreCanal) == str(nombreAux) and str(claveAux) == str(
                            claveAcceso)):
